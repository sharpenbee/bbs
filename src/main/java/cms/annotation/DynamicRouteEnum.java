...
public enum DynamicRouteEnum {
    ...
    /** 群聊列表 **/
    DEFAULT_1210100("群聊列表", 1),
    /** 群聊详情 **/
    DEFAULT_1210200("群聊详情", 1),
    /** 创建群聊表单 **/
    DEFAULT_1210300("创建群聊表单", 1),
    /** 创建群聊 **/
    DEFAULT_1210400("创建群聊", 1),
    /** 拉人进群 **/
    DEFAULT_1210500("拉人进群", 1),
    /** 发送群消息 **/
    DEFAULT_1210600("发送群消息", 1),
    /** 群消息列表 **/
    DEFAULT_1210700("群消息列表", 1),
    /** 群成员列表 **/
    DEFAULT_1210800("群成员列表", 1),
    /** 退出群聊 **/
    DEFAULT_1210900("退出群聊", 1),
    /** 解散群聊 **/
    DEFAULT_1211000("解散群聊", 1),
    /** 标记消息已读 **/
    DEFAULT_1211100("标记消息已读", 1),
    /** 标记所有消息已读 **/
    DEFAULT_1211200("标记所有消息已读", 1),
    /** 群聊未读消息数 **/
    DEFAULT_1211300("群聊未读消息数", 1);
